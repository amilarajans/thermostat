...
public class VmShenandoahBackend extends VmListenerBackend {

    private final VmShenandoahDao dao;

    public VmShenandoahBackend(VmShenandoahDao dao, Version version,
                               VmStatusListenerRegistrar registrar, WriterID writerID) {
        super("VM Shenandoah Backend",
                "Gathers Shenandoah-GC-specific statistics",
    ...
    protected VmUpdateListener createVmListener(String writerId, String vmId, int pid) {
        return new VmShenandoahListener(writerId, vmId, dao);
    }
